...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
 ...
 if (event.body.toLowerCase() == "assalamualaikum" || event.body.toLowerCase() == "assalam alaikum" || event.body.toLowerCase() == "aoa" || event.body.toLowerCase() == "a.o.a") {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞꧁𝐖𝐀𝐐𝐀𝐒-𝐅𝐀𝐈𝐒𝐀𝐋𝐀𝐁𝐀𝐃𝐈꧂☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝕎𝔸ℚ𝔸𝕊🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞https://www.facebook.com/profile.php?id=100091263342763\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @FaiSaLaBaDi_WaQaS😇", threadID);
   };
